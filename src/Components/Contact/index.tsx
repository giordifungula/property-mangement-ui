const Contact = () => {
  // TODO add schema and validations here
  // Add Mailer service
  return (
    <div className="w-full">
      <div className="leading-loose bg-gray-900 pt-10 pb-10">
        <form
          onSubmit={(e) => {
            e.preventDefault();
          }}
          className="max-w-xl mx-auto m-4 mt-0 p-6 sm:p-10 bg-secondary-light dark:bg-secondary-dark rounded-lg shadow-xl text-left"
        >
